...
void R_DrawPlanes(void)
{
	...
	{
		I_Error("R_DrawPlanes: drawsegs overflow (%li)", ds_p - drawsegs);
	}
	if (lastvisplane - visplanes > MAXVISPLANES)
	{
		I_Error("R_DrawPlanes: visplane overflow (%li)", lastvisplane - visplanes);
	}
	if (lastopening - openings > MAXOPENINGS)
	{
		I_Error("R_DrawPlanes: opening overflow (%li)", lastopening - openings);
	}
#endif
